...
class WorkflowRegistryContract(Protocol):
    ...
    def update(self, wf_id: str, **kw: Any) -> dict[str, Any] | None: ...
    def delete(self, wf_id: str) -> bool: ...
    def save_layout(self, wf_id: str, nodes: list, edges: list) -> dict[str, Any] | None: ...
...
class MCPClientManagerContract(Protocol):
    ...
    def add_server(self, config: dict[str, Any]) -> Any: ...
