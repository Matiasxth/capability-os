...
class MemoryWriter(Protocol):
    ...
    def remember(self, key: str, value: Any, memory_type: str = "capability_context", capability_id: str | None = None, ttl_days: int | None = None) -> Any: ...
...
class SemanticMemoryContract(Protocol):
    def remember_semantic(self, text: str, metadata: dict[str, Any] | None = None, memory_type: str = "capability_context", capability_id: str | None = None) -> dict[str, Any] | None: ...
...
class WorkspaceWriter(Protocol):
    ...
    def add(self, name: str, path: str, access: str = "write", capabilities: str | list[str] = "*", color: str = "#00ff88", icon: str = "folder") -> WorkspaceData: ...
    def remove(self, ws_id: str) -> bool: ...
    def set_default(self, ws_id: str) -> bool: ...
    def update(self, ws_id: str, **fields: Any) -> WorkspaceData | None: ...
...
class WorkflowRegistryContract(Protocol):
    ...
    def create(self, name: str, description: str = "", nodes: list | None = None, edges: list | None = None) -> WorkflowData: ...
    def update(self, wf_id: str, **fields: Any) -> WorkflowData | None: ...
...
class TaskQueueContract(Protocol):
    ...
    def add(self, description: str, schedule: str = "daily_09:00", action_type: str = "agent_message", action_message: str = "", agent_id: str | None = None, channel: str | None = None) -> ScheduledTask: ...
    def update(self, task_id: str, **fields: Any) -> ScheduledTask: ...
