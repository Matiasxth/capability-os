"""Executor for Discord Bot API capabilities."""
...
class DiscordCapabilityExecutor:
    """Executes Discord capabilities by delegating to the connector."""
    ...
    def execute(self, capability_id: str, inputs: dict[str, Any]) -> dict[str, Any] | None:
        ...
        try:
            ...
            return {
                "status": "error",
                "execution_id": f"discord_{capability_id}",
